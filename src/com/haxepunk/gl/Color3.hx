...
class Color3 {
	...
	inline public function copyFromFloats(r:Float, g:Float, b:Float) {
		...
		inline public static function Lerp(left:Color3, right:Color3, amount:Float):Color3 {
		var result = new Color3(0, 0, 0);
        return Color3.LerpToRef(left, right, amount, result);
	}
	
	inline public static function LerpToRef(left:Color3, right:Color3, amount:Float, result:Color3):Color3 {
