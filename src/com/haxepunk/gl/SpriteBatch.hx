...
class SpriteBatch
{
	...
	public  var spriteShader:SpriteShader;
	...
	public static var numTex:Int=0;
	public static var numBlend:Int = 0;
	public static var numTris:Int = 0;
	public static var numVertx:Int = 0;
...
private static var _scratchQuadArray :Float32Array = null;
  ...
  if (_scratchQuadArray == null) {
    ...
    GL.bufferData(GL.ARRAY_BUFFER,  new Float32Array(numVerts), GL.DYNAMIC_DRAW);
...
vertices[index++] = r;vertices[index++] = g;vertices[index++] = b;vertices[index++] = a;
 ...
 var CosT:Float  = Math.cos(Rotation*HXP.RAD);
 var SinT:Float  = Math.sin(Rotation*HXP.RAD);
...
vertices[index++] = r;vertices[index++] = g;vertices[index++] = b;vertices[index++] = a;
	...
	{
		if(img.tex!= this.currentBaseTexture || this.currentBatchSize >= this.capacity)
    {
       		switchTexture(img.tex);
    }
...
vertices[index++] = r;vertices[index++] = g;vertices[index++] = b;vertices[index++] = a;		
	...
	public  inline  function drawEntitySize(texture:Texture,
...
vertices[index++] = r;vertices[index++] = g;vertices[index++] = b;vertices[index++] = a;		
	...
	public  inline  function drawEntityUV(texture:Texture,
...
vertices[index++] = r;vertices[index++] = g;vertices[index++] = b;vertices[index++] = a;		
	...
	spriteShader.setProjMatrix(Game.camera.projMatrix);
	spriteShader.setViewMatrix(Game.camera.viewMatrix);
...
private   function flush():Void
{
	...
	spriteShader.setTexture(currentBaseTexture);
  ...
  //  GL.bufferData(GL.ARRAY_BUFFER, vertices, GL.STREAM_DRAW);
    ...
    GL.drawElements(GL.TRIANGLES, currentBatchSize * 6, GL.UNSIGNED_SHORT, 0);
		numTris += currentBatchSize * 6;
	    numVertx += currentBatchSize * 36;
