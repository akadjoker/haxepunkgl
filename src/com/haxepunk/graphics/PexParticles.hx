...
class PexParticles
{
    ...
    public function new ( name :String,path:String)
    {
        ...
        for (element in xml.firstElement().elements()) {
            ...
            case "texture":
				 ...
				 texture=HXP.engine.game.getTexture(path+element.get("name"), false);
    ...
    public function createEmitter () :EmitterGraphic
    {
		
        return new EmitterGraphic(this);
   }
